...
omarchy plugin validate "$APP_DIR"
...
install -m 0755 "$APP_DIR/scripts/uninstall-desktop.sh" "$BIN_DIR/omatut-uninstall"
...
install -m 0644 "$APP_DIR/manifest.json" "$PLUGIN_DIR/manifest.json"
install -m 0644 "$APP_DIR/Overlay.qml" "$PLUGIN_DIR/Overlay.qml"
