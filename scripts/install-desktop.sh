...
sed -e "s|@LAUNCHER@|$BIN_DIR/omatut|g" "$APP_DIR/scripts/omatut.desktop.in" > "$APPLICATION_DIR/omatut.desktop"
...
echo "OmaTut installed with its on-screen guide. Launch it from the Omarchy app launcher or run: omatut"
